...
export class AddobpatientComponent {
  ...
  updatePatientDetails() {
    ...
    if (this.updatePatient.lmp === null || this.updatePatient.lmp === '') {
      ...
      this.patientDetails.lmp = moment(this.updatePatient.lmp).format('YYYY-MM-DD');
    }

    if (this.updatePatient.edd === null || this.updatePatient.edd === '') {
      this.patientDetails.edd = '';
    } else {
      this.patientDetails.edd = moment(this.updatePatient.edd).format('YYYY-MM-DD');
    }

    if (this.updatePatient.postDate === null || this.updatePatient.postDate === '') {
      this.patientDetails.postpartumDate = '';
    } else {
      this.patientDetails.postpartumDate = moment(this.updatePatient.postDate).format('YYYY-MM-DD');
    }
    ...
    if (this.updatePatient.babyBirthDate === null || this.updatePatient.babyBirthDate === '') {
      this.patientDetails.babyBirthDate = '';
    } else {
      this.patientDetails.babyBirthDate = moment(this.updatePatient.babyBirthDate).format('YYYY-MM-DD');
    }
    ...
    if (this.updatePatient.pcrList === null || this.updatePatient.pcrList.length === 0) {
    ...
    if (this.updatePatient.patientProceduresList.length > 0) {
      this.updatePatient.patientProceduresList.forEach((proce, index) => {
        this.selectedProcedure.push(proce.procedureTypes.id.toString());
        if (index === 0) {
    ...
    if (this.updatePatient.babyInfo === null || this.updatePatient.babyInfo === '') {
      this.patientDetails.babyInfo = '';
    } else {
      if (this.updatePatient.babyInfo === 1 || this.updatePatient.babyInfo === 2) {
    ...
    if (this.updatePatient.birthWeight === null || this.updatePatient.birthWeight === '') {
      this.patientDetails.birthWeight = '';
    } else {
      this.patientDetails.birthWeight = this.updatePatient.birthWeight;
    }
    if (this.updatePatient.babyGender === null || this.updatePatient.babyGender === '') {
  ...
  onProcedureChange(event: any) {
    this.patientDetails.procedureTypesId = event.target.value;
  ...
  updatePostDate(event: any) {
    this.patientDetails.postpartumDate = moment(event.target.value).format('YYYY-MM-DD');
  ...
  updateAdmitDate(event: any) {
    this.patientDetails.admitDate = moment(event.target.value).format('YYYY-MM-DD');
  }
  updatebabyAdmitDate(event: any) {
    this.patientDetails.babyBirthDate = moment(event.target.value).format('YYYY-MM-DD');
  }
  ...
  updatePatientForm() {
    this.getDetails();
    this.patientDetails['userId'] = this.updatePatient.mstUsers.userId.toString();
  ...
  getDetails() {
    ...
    if (this.patientDetails.lmp !== '') {
      this.patientDetails.lmp = moment(this.patientDetails.lmp).format('MM-DD-YYYY');
    }
    if (this.patientDetails.edd !== '') {
      this.patientDetails.edd = moment(this.patientDetails.edd).format('MM-DD-YYYY');
    }
    if (this.patientDetails.postpartumDate !== '') {
      this.patientDetails.postpartumDate = moment(this.patientDetails.postpartumDate).format('MM-DD-YYYY');
    }
    if (this.patientDetails.babyBirthDate !== '') {
      this.patientDetails.babyBirthDate = moment(this.patientDetails.babyBirthDate).format('MM-DD-YYYY');
    }

    this.cpModeList.forEach((section) => {
      if (section.isChecked) {
        if (this.patientDetails.mode.length > 0) {
          this.patientDetails.mode = this.patientDetails.mode + ',' + section.id.toString();
        } else {
          this.patientDetails.mode = section.id.toString();
        }
      }
    });
    this.patientDetails.gsps = this.gspsg + '|' + this.gspst + '|' + this.gspsp + '|' + this.gspsa + '|' + this.gspsl;
    this.inReason.forEach((induceds) => {
      if (induceds.isChecked) {
        if (this.patientDetails.inducedReason.length > 0) {
          this.patientDetails.inducedReason = this.patientDetails.inducedReason + ',' + induceds.id.toString();
        } else {
  ...
  async getGastalAge() {
    this.gsdays = [{ text: '0 day', value: '0' }, { text: '1 day', value: '0' }, { text: '2 days', value: '2' },
      { text: '3 days', value: '3' }, { text: '4 days', value: '4' }, { text: '5 days', value: '5' },
      { text: '6 days', value: '6' }];

    this.gsWeeks =
      [{ text: '0 Weeks', value: '0' }, { text: '1 Week', value: '1' }, { text: '2 Weeks', value: '2' },
        { text: '3 Weeks', value: '3' }, { text: '4 Weeks', value: '4' }, { text: '5 Weeks', value: '5' },
        { text: '6 Weeks', value: '6' }, { text: '7 Weeks', value: '7' }, { text: '8 Weeks', value: '8' },
        { text: '9 Weeks', value: '9' }, { text: '10 Weeks', value: '10' }, { text: '11 Weeks', value: '11' },
        { text: '12 Weeks', value: '12' }, { text: '13 Weeks', value: '13' }, { text: '14 Weeks', value: '14' },
        { text: '15 Weeks', value: '15' }, { text: '16 Weeks', value: '16' }, { text: '17 Weeks', value: '17' },
        { text: '18 Weeks', value: '18' }, { text: '19 Weeks', value: '19' }, { text: '20 Weeks', value: '20' },
        { text: '21 Weeks', value: '21' }, { text: '22 Weeks', value: '22' }, { text: '23 Weeks', value: '23' },
        { text: '24 Weeks', value: '24' }, { text: '25 Weeks', value: '25' }, { text: '26 Weeks', value: '26' },
        { text: '27 Weeks', value: '27' }, { text: '28 Weeks', value: '28' }, { text: '29 Weeks', value: '29' },
        { text: '30 Weeks', value: '30' }, { text: '31 Weeks', value: '31' }, { text: '32 Weeks', value: '32' },
        { text: '33 Weeks', value: '33' }, { text: '34 Weeks', value: '34' }, { text: '35 Weeks', value: '35' },
        { text: '36 Weeks', value: '36' }, { text: '37 Weeks', value: '37' }, { text: '38 Weeks', value: '38' },
        { text: '39 Weeks', value: '39' }, { text: '40 Weeks', value: '40' }, { text: '41 Weeks', value: '41' },
