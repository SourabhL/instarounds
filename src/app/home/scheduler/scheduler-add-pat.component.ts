...
@Component({
  selector: "scheduler-add-ob-patients",
  styleUrls: ["./scheduler-add-pat.component.scss"],
  templateUrl: "./scheduler-add-pat.component.html",
})
export class SchedulerAddPatientComponent {
  @Input() patient: any;
  patientDetails = {
  ...
  ngOnInit() {
    console.log("patient Row........", this.patient);
    if (this.patient.patient_id) {
      this.patientType = "update";
      this.patientStatus = "census";
